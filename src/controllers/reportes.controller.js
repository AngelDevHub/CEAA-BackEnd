...
class ReportesController {
  async diario(req, res) {
    try {
      ...
      const litrosTotales = Number(
        riegos.reduce((acc, b) => acc + (Number(b.litros_estimados) || 0), 0).toFixed(3)
      );
      ...
      return res.json({
        ...
        data: {
          ...
          operacion: {
            ...
            evidencia: bitacoras.slice(0, 10)
          }
        }
      });
    } catch (error) {
      ...
      return res.json({
        ...
        data: {
          ...
          operacion: {
            ...
            evidencia: bitacoras.slice(0, 20)
          }
        }
      });
    } catch (error) {

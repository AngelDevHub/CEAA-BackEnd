...
import { validateLogin, validateRegister, validateUpdateProfile } from '../../middlewares/sanitizeMiddleware.js';
...
router.put('/perfil', validateToken, validateUpdateProfile, inicioSesionController.updatePerfil);
